...
cd "${EFFDET_SRC}/preprocessing" && \ 
  python3 generate_tfrecord.py -x ${IMAGE_DIR}/train -l ${ANNO_DIR}/label_map.pbtxt -o ${IMAGE_DIR}/train.record && \
  python3 generate_tfrecord.py -x ${IMAGE_DIR}/test -l ${ANNO_DIR}/label_map.pbtxt -o ${IMAGE_DIR}/test.record
