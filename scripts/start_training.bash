...
if [-d "train.record"]; then
    ...
    #Prevents training if record files where not made
    echo -e "\n"
    echo ".record file not created, check that images and label.map file are in the correct files"
    echo -e "\n"
fi
